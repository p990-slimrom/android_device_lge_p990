...
/dev/block/mmcblk0p2                           /cache            ext4    discard,noatime,nosuid,nodev,data=writeback,nodelalloc,errors=panic  wait
/dev/block/mmcblk0p9                           /data             ext4    discard,noatime,nosuid,nodev,data=writeback,nodelalloc,errors=panic  wait,encryptable=footer
