...
/dev/block/mmcblk0p2                           /cache            ext4    noatime,nosuid,nodev,nomblk_io_submit,errors=panic           wait,check
/dev/block/mmcblk0p9                           /data             ext4    noatime,nosuid,nodev,nomblk_io_submit,errors=panic           wait,check,encryptable=footer
